...
public class Login extends JPanel{
	...
	public Login(Application j) {
		...
		bg.setIcon(new ImageIcon( new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\bg.jpg").getImage(1281,658)));
		
		JLabel color=new JLabel(new ImageIcon( new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\color.png").getImage(35,35)));
		color.setSize(35,35);
		...
		JLabel img=new JLabel(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\ProjectForm\\src\\img\\icon2.png").getImage(50,50)));
		img.setSize(400,50);
		...
		emailInput.getDocument().addDocumentListener(new TextListener() {
			...
			public void update(DocumentEvent e) {
				...
				if(isEmail(s)) {
					etick.setIcon(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\ProjectForm\\src\\img\\tick.gif").getImage(16,16)));
				}
				else {
					etick.setIcon(null);
				}
