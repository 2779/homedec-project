...
public class OrderPanel extends JFrame{
	...
	private void setStatus(int status) {
		Container co=getContentPane();
		JLabel s1=new JLabel(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\gb.png").getImage(7, 7)));
		s1.setSize(20, 20);
		...
		JLabel s2=new JLabel(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\gb.png").getImage(7, 7)));
		s2.setSize(20, 20);
		...
		JLabel s3=new JLabel(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\gb.png").getImage(7, 7)));
		s3.setSize(20, 20);
		...
		JLabel s4=new JLabel(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\"+((status==0)?"gb.png":"rb1.png")).getImage(7, 7)));
		s4.setSize(20, 20);
