...
public class ProductViewPanel extends JPanel{
	...
	public ProductViewPanel(Application j){
		...
		JLabel icon=new JLabel(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\homedec.png").getImage(40, 40)));
		icon.setSize(50,50);
		...
		JLabel cart=new JLabel(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\cart.png").getImage(40, 40)));
		cart.setSize(50,50);
		cart.setCursor(new Cursor(Cursor.HAND_CURSOR));
		title.add(cart);
		
		JLabel profile=new JLabel(new ImageIcon(new ImgPack("C:\\Users\\niyaz\\OneDrive\\Documents\\bootcampexercises\\55-27aug2021projectpresent\\project\\shopping_app\\shopping_app\\img\\pro.png").getImage(40, 40)));
